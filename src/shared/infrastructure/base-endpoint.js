...
export class BaseEndpoint {
     ...
     * @param {string} endpointPath - URL path segment for this endpoint (e.g. `/orders`).
     */
     ...
     */
    getById(id) {
        return this.http.get(`${this.endpointPath}/${encodeURIComponent(id)}`);
    }
     ...
     */
    update(id, resource) {
        return this.http.put(`${this.endpointPath}/${encodeURIComponent(id)}`, resource);
    }
     ...
     * @returns {Promise<import('axios').AxiosResponse>} Promise resolving to the patched resource response.
     */
    patch(id, resource) {
        return this.http.patch(`${this.endpointPath}/${encodeURIComponent(id)}`, resource);
    }
     ...
     */
    delete(id) {
        return this.http.delete(`${this.endpointPath}/${encodeURIComponent(id)}`);
    }
}
