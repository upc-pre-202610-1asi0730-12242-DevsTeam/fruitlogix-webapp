...
// Customer view
const customerTrackingView = () => import('./views/customer-tracking-view.vue');
...
const logisticsMonitoringRoutes = [
    ...
    { path: 'customer-tracking/:id', name: 'customer-tracking', component: customerTrackingView, meta: { title: 'Rastrear Pedido', requiresAuth: true, role: 'customer' } }
];
